...
### 성장
- 경험치를 모아서 성장할때마다 카드를 선택 할수 있다. 
- 동일카드를 또 얻는 다면 카드가 다음 레벨로 성장한다. 
- 최대 6성까지 성장 가능하다.

### 기본 스탯 성장
- 인게임에서가 아닌 아웃게임에서 카드 성장이 가능하다. 
- 각 카드를 VIP 뽑기로 뽑아서 수량으로 강화하면 
- 해당 카드는 무한대로 성장이 가능하다. 
- 성장한 카드의 수치는 인게임에서 기본 수치로 적용된다.
- 아웃게엠애ㅣ서 카드를 10강했다면 사실상 인게임 6강을 포함 최대 16강까지 성장 가능하다.
